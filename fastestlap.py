...
gp = input('Grand Prix:') # use the full name of the grand prix
event = input('Event (FP1, FP2, FP3, Q, SQ, R):')
driver1 = input('Driver 1:')
driver2 = input('Driver 2:')

# enable cache
fastf1.Cache.enable_cache('f1/cachef1')#directory to save cache
...
fig, ax = plt.subplots()
ax.plot(driver1_tel['Distance'], driver1_tel['Speed'], color=driver1_team_color,
        label=f"{driver1_lap['Driver']} ({driver1_lap['Compound']})")
ax.plot(driver2_tel['Distance'], driver2_tel['Speed'], color=driver2_team_color,
        label=f"{driver2_lap['Driver']} ({driver2_lap['Compound']})")
